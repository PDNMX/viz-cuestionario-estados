...
function handleStepEnter(response) {
  ...
  let activationFunctions = [chartTabla, chartMexicoPuntuacion, chartStackedBar, chartPictogram, chartInfraestructura, chartCapitalHumano, chartMapeoGestion, chartDevMecanismos]
