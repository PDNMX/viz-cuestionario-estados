...
const puntajeV1 = "<li><b>Normativa</b>: 10 puntos;</li> <li><b>Infraestructura</b>: 20 puntos;</li> <li><b>Capital humano</b>: 10 puntos;</li> <li><b>Mapeo y gestión de datos</b>: 30 puntos, y</li> <li><b>Desarrollo de mecanismos de comunicación</b>: 30 puntos.</li>"
const puntajeV2 = "<li><b>Normativa</b>: 10 puntos,</li> <li><b>Capital humano</b>: 20 puntos y</li> <li><b>Proceso de interconexión</b>: 70 puntos.</li>"
const puntajeV3 = "<li><b>Avance en la Normativa</b>: 20 puntos,</li> <li><b>Capital humano</b>: 20 puntos y</li> <li><b>Herramientas de interconexión</b>: 60 puntos.</li>"
...
const txt1v2 = "<h2 class='tituloSeccion'>Avances de interconexión subnacional. Sistemas 1, 2, 3 y 6. </h2> <h3>Puntos por Categoría</h3> <p>Este tablero representa los avances trimestrales de las Secretarías Ejecutivas de los Sistemas Locales Anticorrupción en el desarrollo de los sistemas: (1) de evolución patrimonial, de declaración de intereses y constancia de presentación de declaración fiscal, (2) de servidores públicos que intervengan en procedimientos de contrataciones públicas y (3) de servidores públicos y particulares sancionados, con base en un cuestionario que incluye las siguientes categorías: </p> <ul class='no_bullet'> <li class='general'><b>General</b>: permite recabar información para mantener contacto con personal encargado del desarrollo de la Plataforma Digital o un Sistema de Información de las  Secretarías Ejecutivas de los Sistemas Estatales Anticorrupción.</li> <li class='normatividad'><b>Normatividad</b>: permite conocer el avance de las Secretarías Ejecutivas de los Sistemas Estatales Anticorrupción en la elaboración de sus bases para el funcionamiento de su plataforma digital o sistema de información.</li> <li class='capitalHumano'><b>Capital Humano</b>: permite saber si las Secretarías Ejecutivas de los Sistemas Estatales Anticorrupción cuentan con un equipo interno o externo encargado del desarrollo de su plataforma digital o sistema de información.</li> <li class='devMecanismos'><b>Proceso de interconexión</b>: permite conocer el avance de las Secretarías Ejecutivas de los Sistemas Estatales Anticorrupción en la incorporación de datos a la PDN.</li></ul>"
const txt1v3 = '<h2 class="tituloSeccion"> Avances de interconexión subnacional. Sistemas 1, 2, 3 y 6. </h2> <h3>Puntos por Sección</h3> <p> Este tablero representa los avances trimestrales de las Secretarías Ejecutivas de los Sistemas Locales Anticorrupción en el desarrollo de los sistemas: (1) de evolución patrimonial, de declaración de intereses y constancia de presentación de declaración fiscal, (2) de servidores públicos que intervengan en procedimientos de contrataciones públicas, (3) de servidores públicos y particulares sancionados y (6) de información pública de contrataciones, con base en un cuestionario que incluye las siguientes categorías: </p> <ul class="no_bullet"> <li class="general"> <b>Datos Generales</b>: permite conocer los datos generales y de contacto de las personas servidoras públicas de las SESEAs encargadas de responder el cuestionario.<br />Esta sección es de carácter informativo, por lo que no se les asignará ningún puntaje. </li> <li class="normatividad"> <b>Avance de la Normativa</b>: permite conocer el avance de las SESEAs en la elaboración y publicación de los instrumentos normativos relacionados con el funcionamiento de sus Plataforma Digitales o Sistema de información (bases o lineamientos, Declaratorias de inicio de funciones, lineamientos para incorporar la información y catálogo de perfiles, entre otros). </li> <li class="capitalHumano"> <b>Capital Humano</b>: permite conocer si las SESEAs cuentan con personal técnico encargado del desarrollo de sus Plataforma Digitales o Sistemas de Información, así como de la interconexión con la PDN. </li> <li class="devMecanismos"> <b>Herramientas de interconexión:</b> permite conocer la infraestructura con la que las SESEAs cuentan para la incorporación de datos a los Sistemas de Información de la PDN. </li> </ul>'
...
const txt1v2After = "<p><strong>La tabla de la derecha muestra el porcentaje de avance de las entidades federativas para cada una de las categorías evaluadas. </strong></p>"
const txt1v3After = "<p><strong>La tabla de la derecha muestra el porcentaje de avance de las entidades federativas para cada una de las secciones evaluadas. </strong></p>"
...
const txtMapav2 = "<p>Este mapa muestra el grado de avance de las entidades federativas en los trabajos para alcanzar la interconexión con la PDN en los sistemas 1, 2, 3 y 6. Da clic en cualquier estado para consultar su gráfico de radar, en el que los ejes representan las categorías contempladas para medir los avances.</p>"
...
function drawInitial(dataset) {
    ...
    mexico.objects.collection.geometries.forEach(function(element){
        ...
        dataset.forEach(function(newElement) {
            ...
            if(parseInt(element.properties.clave)===parseInt(newElement[1])){
                ...
                if(versionMetologia == 'v2' || versionMetologia == 'v3'){
                    // Set data of Google Spreadsheets
                    element.properties.entidad=newElement[0];
    ...
    svg.append("g")
        ...
        .on('click', function (d) {
            ...
            if(versionMetologia == 'v3') {
                dataTest = [
                    [
                        {"area": "Normativa ", "value": d.properties.porcentajeNor},
                        {"area": "Capital humano ", "value": d.properties.porcentajeInf},
                        {"area": "Herramientas de Interconexión", "value": d.properties.porcentajeCH}
                    ]
                  ];
            }  
    ...
    */
    ...
    if (versionMetologia == 'v3'){
        z = d3.scaleOrdinal(['#34B3EB', '#674ea7', '#fbbc04']);
        group = ["Normativa", "Capital humano", "Herramientas de Interconexión"];
        topData = dataset.sort(function (a, b) {
            return d3.descending(+a[12], +b[12]);
        }).slice(0, 10);
    ...
    dataset.forEach(function(d) {
        ...
        if (versionMetologia == 'v3'){
            tempData = {
                Entidad: d[0],
                'Normativa': Number.parseFloat(d[5]),
                'Capital humano': Number.parseFloat(d[8]),
                'Herramientas de Interconexión': Number.parseFloat(d[11]),
                total: Number.parseFloat(d[13])
            };
        }
